                    ...
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu sub-group-active">
                                <li className="nav-item">
                                    <NavLink to="/all_book" className="nav-link menu-active"><i className="fa fa-angle-right"></i>All Book</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/all_classes" className="nav-link"><i className="fa fa-angle-right"></i>All Classes</NavLink>
                                </li>
                                <li className="nav-item">
