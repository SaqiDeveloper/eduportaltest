                    ...
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <NavLink to="/students" className="nav-link"><i className="fa fa-angle-right"></i>Students</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/parents" className="nav-link"><i className="fa fa-angle-right"></i>Parents</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/teachers" className="nav-link"><i className="fa fa-angle-right"></i>Teachers</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/allstudent" className="nav-link"><i className="fa fa-angle-right"></i>All Students</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/studentdetails" className="nav-link"><i className="fa fa-angle-right"></i>Student Details</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/admitform" className="nav-link"><i className="fa fa-angle-right"></i>Admission Form</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/studentpromotion" className="nav-link"><i className="fa fa-angle-right"></i>Student Promotion</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu sub-group-active">
                                <li className="nav-item">
                                    <NavLink to="/allteacher" className="nav-link menu-active"><i className="fa fa-angle-right"></i>All Teachers</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            <NavLink to="/all_classes" className="nav-link"><i className="flaticon-maths-class-materials-cross-of-a-pencil-and-a-ruler"></i><span>Class</span></NavLink>
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/all_classes" className="nav-link"><i className="fa fa-angle-right"></i>All ClassNamees</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/add_class" className="nav-link"><i className="fa fa-angle-right"></i>Add New ClassName</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="/class_routine" className="nav-link"><i className="flaticon-calendar"></i><span>ClassName Routine</span></NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to="/student_attendence" className="nav-link"><i className="flaticon-checklist"></i><span>Attendence</span></NavLink>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            <NavLink to="#" className="nav-link"><i className="flaticon-shopping-list"></i><span>Exam</span></NavLink>
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="/notice_board" className="nav-link"><i className="flaticon-script"></i><span>Notice</span></NavLink>
                        </li>
                        <li className="nav-item">
                         ...
                         <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/notificationalart.html" className="nav-link"><i className="fa fa-angle-right"></i>Alart</NavLink>
                                </li>
                                <li className="nav-item">
