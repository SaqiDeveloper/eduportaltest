                    ...
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu sub-group-active">
                                <li className="nav-item">
                                    <NavLink to="/exam_schedule" className="nav-link menu-active"><i className="fa fa-angle-right"></i>Exam
                                        Schedule</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="notice-board.html" className="nav-link"><i
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="form-check">
                                                        ...
                                                        <label className="form-check-label">className Test</label>
                                                    </div>
                                                </td>
                                                <td>Mathematics</td>
                                                <td>4</td>
