                    ...
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <NavLink to="teacher-details.html" className="nav-link"><i className="fa fa-angle-right"></i>Teacher Details</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="add-teacher.html" className="nav-link"><i className="fa fa-angle-right"></i>Add Teacher</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="teacher-payment.html" className="nav-link"><i className="fa fa-angle-right"></i>Payment</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <NavLink to="parents-details.html" className="nav-link"><i className="fa fa-angle-right"></i>Parents Details</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="add-parents.html" className="nav-link"><i className="fa fa-angle-right"></i>Add Parent</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <NavLink to="add-book.html" className="nav-link"><i className="fa fa-angle-right"></i>Add New Book</NavLink>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/all_classes" className="nav-link"><i className="fa fa-angle-right"></i>All class</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="/notice" className="nav-link menu-active"><i className="flaticon-script"></i><span>Notice</span></NavLink>
                        </li>
                        <li className="nav-item">
                            ...
                            <div className="card-body">
                                ...
                                <div className="notice-board-wrap">
                                    <div className="notice-list">
                                        ...
                                        <h6 className="notice-title"><NavLink to="#">Great School Great School manag mene esom  
                                            text of the printing Great School manag mene esom  text of the printing manag 
                                            mene esom  text of the printing.</NavLink></h6>
                                        <div className="entry-meta">  Jennyfa Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div className="notice-list">
