                ...
                <div className="sidebar-menu-content">
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        <li className="nav-item sidebar-nav-item">
                            <NavLink to="/admin_dashboard" className="nav-link"><i className="flaticon-dashboard"></i><span>Dashboard</span></NavLink>
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <NavLink to="/teachers" lassName="nav-link"><i
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu sub-group-active">
                                <li className="nav-item">
                                    <NavLink to="/allstudent" className="nav-link menu-active"><i className="fa fa-angle-right"></i>All
                                        Students</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            <NavLink to="#" className="nav-link"><i className="flaticon-books"></i><span>Library</span></NavLink>
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <NavLink to="/allbook" className="nav-link"><i className="fa fa-angle-right"></i>All
                                        Book</NavLink>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="/class_routine" className="nav-link"><i className="flaticon-calendar"></i><span>ClassName
