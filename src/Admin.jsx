                        ...
                        <div className="card dashboard-card-one pd-b-20">
                            <div className="card-body">
                                ...
                                <div className="earning-report">
                                    ...
                                    <div className="dropdown">
                                        <NavLink className="date-dropdown-toggle" to="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">Jan 20, 2019</NavLink>
                                        <div className="dropdown-menu dropdown-menu-right">
                                            <NavLink className="dropdown-item" to="#">Jan 20, 2019</NavLink>
                                            <NavLink className="dropdown-item" to="#">Jan 20, 2021</NavLink>
                                            <NavLink className="dropdown-item" to="#">Jan 20, 2020</NavLink>
                                        </div>
                                    </div>
                                </div>
